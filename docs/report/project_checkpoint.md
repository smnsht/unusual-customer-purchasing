...
- **Week 1:** ✅ [Completed] EDA, preprocessing, and feature engineering
- **Week 2:** ✅ [Completed] Unusual purchasing behavior analysis
- **Week 3:** 🔄 [Work in progress] Report preparation

The project is too large to fully capture in the slides/report format: it includes many plots with accompanying commentary that are interlinked and not meaningful in isolation.

For the full analysis, see the notebooks [on GitHub](https://github.com/smnsht/unusual-customer-purchasing/tree/dev/notebooks).
